...
import com.edu.journal.databinding.DialogCityBinding;
import com.edu.journal.db.bean.Province;
import com.edu.journal.ui.adapter.AdministrativeClickCallback;
import com.edu.journal.ui.adapter.AreaAdapter;
import com.edu.journal.ui.adapter.CityAdapter;
import com.edu.journal.ui.adapter.ProvinceAdapter;
...
public class CityDialog implements AdministrativeClickCallback {
    ...
    public void show() {
        ...
        binding.ivSubmit.setOnClickListener(v -> {
            if (selectedCityCallback != null) {
                selectedCityCallback.selectedCity(cityName,areaName);
                dialog.dismiss();
            }
        });
    ...
    public interface SelectedCityCallback {
        void selectedCity(String cityName,String areaName);
    }
}

...
import com.edu.mylibrary.network.errorhandler.ExceptionHandle;
import com.edu.mylibrary.network.errorhandler.HttpErrorHandler;
import com.edu.mylibrary.network.interceptor.RequestInterceptor;
import com.edu.mylibrary.network.interceptor.ResponseInterceptor;
...
public class NetworkApi {
    ...
    private static void getBaseUrl(ApiType apiType) {
        switch (apiType) {
            case SEARCH:
                mBaseUrl = "https://mg44u8rf5v.re.qweatherapi.com";//和风天气host
                break;
            case WEATHER:
                mBaseUrl = "https://mg44u8rf5v.re.qweatherapi.com";
            default:
                mBaseUrl ="https://mg44u8rf5v.re.qweatherapi.com";
                break;
        }
